 ...
 */
final class Version20220322155138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suite ADD slug VARCHAR(255) NOT NULL, CHANGE thumbnail thumbnail VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE attachement CHANGE image image VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
